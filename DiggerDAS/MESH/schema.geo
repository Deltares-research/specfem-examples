...
Point(7) = {5.25, 0, 0, lc};
Point(8) = {5.25, 0.5, 0, lc};
Point(9) = {5.25, 1, 0, lc};
Point(10) = {5.25, 1.75, 0, lc};
Point(11) = {5.0, 1.75, 0, lc};
Point(12) = {4.75, 1.75, 0,lc};
Point(13) = {4.75, 1, 0, lc};
Point(14) = {4.75, 0.5, 0, lc};
Point(15) = {4.75, 0, 0, lc};
