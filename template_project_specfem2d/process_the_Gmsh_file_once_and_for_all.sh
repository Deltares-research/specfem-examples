...
# creates Gmsh mesh
gmsh project.geo -2 -format msh22 -o project.msh
...
python $SPECFEM2D_ROOT/utils/Gmsh/LibGmsh2Specfem_convert_Gmsh_to_Specfem2D_official.py project.msh -t F -l A -b A -r A
